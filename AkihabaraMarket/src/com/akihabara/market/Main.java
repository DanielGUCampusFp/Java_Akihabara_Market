        ...
        while (!salir) {
            ...
            switch (opcion) {
                ...
                case 7:
                    ...
                    break;
                case 8:
                    String tipo = vista.pedirTipoProducto();
                    String franquicia = vista.pedirFranquiciaProducto();
                    
                    LlmService ia = new LlmService();
                    
                    String nombreIA = ia.sugerirNombreProducto(tipo, franquicia);
                    vista.mostrarMensaje("Nombre sugerido por la IA: " + nombreIA);

                    ProductoOtaku productoIA = vista.pedirDatosProductoAPI(nombreIA);
                    
                    dao.agregarProducto(productoIA);
                    break;
                case 9:
